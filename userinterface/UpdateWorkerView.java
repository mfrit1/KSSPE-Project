...
/** The class containing the Update Worker View  for the KSSPE inventory management application 
 */
//==============================================================
public class UpdateWorkerView extends View implements Observer
{
	...
	public void populateFields()
	{
		...
		System.out.println(firstNameState);
	...
	private VBox createFormContent()
	{
		...
		bannerId = new TextField();
			...
			bannerId.setText((String)myController.getState("BannerId"));
		...
		submitButton = new Button("Update", icon);
